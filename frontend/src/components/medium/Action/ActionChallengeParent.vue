...
import { ProofAttempt, Sprig } from '../../../sprig';
...
<template>
    ...
    <div class="bg-slate-100 p-4 mt-2 rounded-md flex flex-col shadow-sm">
        ...
        <ul class="list-disc list-inside">
            <li>Lock a bounty of <Price :amount="params.questionBounties[attempt.height]"/> </li>
            ...
            <li>The first accepted proof attempt is rewarded with your bounty of <Price :amount="params.questionBounties[attempt.height]"/> </li>
