                    ...
                    " :class="stat.color">
                        ...
                        <div class=" flex flex-col space-y-8 mb-12">
                            <div v-for="content in texts" :key="content.title"
                                ...
                                <div class="mt-2">
                                    <iframe width="560" height="315" :src="content.video" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
