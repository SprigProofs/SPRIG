<template>
    <div>
        ...
        <div class="mt-1 relative rounded-md shadow-sm w-[12.25rem]">
            <input type="number" min="1" :name="id" :id="id"
                v-model="duration" @input="emitUpdate()"
                class="appearance-none focus:ring-indigo-500 focus:border-indigo-500 block !w-full pl-3 pr-28 sm:text-sm border-gray-300 rounded-md "
                placeholder="1" />
